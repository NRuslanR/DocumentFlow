...
begin
  ...
  RaiseConditionalExceptionIfInvariantsComplianceRequested(
    ...
    'Ќе указан исполнитель во врем€ изменени€ поручени€'
  );
...
begin
  ...
  if not Assigned(Performer) then
    Raise TDocumentChargeException.Create('¬о врем€ создани€ поручени€ не указан исполнитель');

  if not Assigned(WorkingRules) then
    Raise TDocumentChargeException.Create('¬о врем€ создани€ поручени€ не были указаны рабочие правила');
...
begin
  ...
  RaiseConditionalExceptionIfInvariantsComplianceRequested(
    ...
    TDocumentChargeException,
    'ѕопытка выполнить поручение на основании невыполненного'
  );

  RaiseConditionalExceptionIfInvariantsComplianceRequested(
    not Performer.IsSameAs(OtherCharge.Performer),
    TDocumentChargeException,
    '—отрудник "%s" не €вл€етс€ исполнителем ' +
  ...
  RaiseConditionalExceptionIfInvariantsComplianceRequested(
    ...
    TDocumentChargeException,
    'Ќе указан фактически выполнивший поручение сотрудник'
  );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    'ѕрограммна€ ошибка. Ќельз€ вызывать ' +
    'метод помечени€ поручени€ в качестве исполненного'
  );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    'Ќельз€ устанавливать фактически ' +
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    TDocumentChargeException,
    '»змен€ть документ поручени€ недопустимо'
  );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    '“ип поручени€ не может устанавливатьс€ непосредственно'
  );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    '»сполнитель может устанавливатьс€ только ' +
    'при создании поручени€'
  );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    TDocumentChargeException,
    'ƒата выполнени€ поручени€ не может ' +
    'устанавливатьс€ непосредственно'
  );
  ...
  if not VarIsType(Value, varDate) then begin
    ...
    raise TDocumentChargeException.Create(
      'ƒата исполнени€ поручени€ должна иметь тип даты'
    );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    TDocumentChargeException,
    '—лужебное наименование типа поручени€ ' +
    'не может устанавливатьс€ непосредственно'
  );
...
begin
  ...
  RaiseExceptionIfInvariantsComplianceRequested(
    TDocumentChargeException,
    '—рок окончани€ поручени€ ' +
    'не может устанавливатьс€ ' +
    'непосредственно'
  );
...
begin
  ...
  if TimeFrameStart > TimeFrameDeadline then begin
    ...
    raise TDocumentChargeException.Create(
            '”казан некорректный срок исполнени€ поручени€'
          );
...
begin
  ...
  if Contains(Charge.Performer) then begin
    ...
    Raise TDocumentChargeException.CreateFmt(
      'ѕоручение дл€ сотрудника "%s" уже назначено',
      [
