...
begin
  ...
  case PerformingResult of
    ...
    prApproved: Result := '—огласовано';
    prRejected: Result := 'Ќе согласовано';
    prNotPerformed: Result := 'Ќе выполнено';
...
begin
  ...
  if InvariantsComplianceRequested then
    raise Exception.Create(
            '«амечани€ дл€ согласовани€ ' +
            'не могут устанавливатьс€ ' +
            'непосредственно'
          ); }
