...
type
  ...
  TDocumentApprovingSetHolder = class (TAbstractDataSetHolder)
    ...
    protected
      ...
      function GetPerformingResultServiceNameFieldName: String;
      ...
      procedure SetPerformingResultServiceNameFieldName(const Value: String);
    ...
    protected
      ...
      procedure SetPerformingResultServiceNameFielValue(const Value: String);
    ...
    published
      ...
      property PerformingResultServiceNameFieldName: String
      read GetPerformingResultServiceNameFieldName
      write SetPerformingResultServiceNameFieldName;
    ...
    published
      ...
      write SetPerformingResultServiceNameFielValue;
...
function TDocumentApprovingSetHolder.GetPerformingResultServiceNameFieldName: String;
begin

  Result := FieldDefs.PerformingResultServiceNameFieldName;

end;

function TDocumentApprovingSetHolder.GetPerformingResultServiceNameFieldValue: String;
begin

  Result := GetDataSetFieldValue(PerformingResultServiceNameFieldName, '');
...
procedure TDocumentApprovingSetHolder.SetPerformingResultServiceNameFieldName(
  const Value: String);
begin

  FieldDefs.PerformingResultServiceNameFieldName := Value;

end;

procedure TDocumentApprovingSetHolder.SetPerformingResultServiceNameFielValue(
  const Value: String);
begin

  SetDataSetFieldValue(PerformingResultServiceNameFieldName, Value);
