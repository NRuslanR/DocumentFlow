...
type
  ...
  TOnDocumentUploadingToLoodsmanEventHandler =
    procedure (Sender: TObject) of object;

  TOnCancellationDocumentUploadingToLoodsmanEventHandler =
    procedure (Sender: TObject) of object;
...
type
  ...
  protected
    ...
    FOnDocumentUploadingToLoodsmanEventHandler:
      TOnDocumentUploadingToLoodsmanEventHandler;

    FOnCancellationDocumentUploadingToLoodsmanEventHandler:
      TOnCancellationDocumentUploadingToLoodsmanEventHandler;
  ...
  public
    ...
    procedure OnDocumentUploadingToLoodsman(Sender: TObject);
    procedure OnCancellationDocumentUploadingToLoodsman(Sender: TObject);
  ...
  published
    ...
    property OnDocumentUploadingToLoodsmanEventHandler:
      TOnDocumentUploadingToLoodsmanEventHandler
    read FOnDocumentUploadingToLoodsmanEventHandler
    write FOnDocumentUploadingToLoodsmanEventHandler;

    property OnCancellationDocumentUploadingToLoodsmanEventHandler:
      TOnCancellationDocumentUploadingToLoodsmanEventHandler
    read FOnCancellationDocumentUploadingToLoodsmanEventHandler
    write FOnCancellationDocumentUploadingToLoodsmanEventHandler;
...
begin
  ...
  FDocumentChargesFrame.SelectRecordByPerformer(WorkingEmployeeId);
...
begin
  ...
  if DocumentInformationFrame.ClassType <> ClassType then Exit;
...
begin
  ...
  if Assigned(FDocumentChargesFrame) then begin
    ...
    FDocumentChargesFrame.SelectRecordByPerformer(Id);
...
procedure TDocumentCardFrame.RefreshByViewModel;
begin
  ...
  then begin
    ...
    FDocumentApprovingsFrame.ViewModel :=
      FViewModel.DocumentApprovingsFormViewModel;
  ...
  then begin
    ...
    FDocumentMainInformationFrame.ViewModel :=
      FViewModel.DocumentMainInformationFormViewModel;
  ...
  then begin
    ...
    FDocumentFilesFrame.ViewModel :=
      FViewModel.DocumentFilesFormViewModel;
  ...
  then begin
    ...
    FDocumentRelationsFrame.ViewModel :=
      FViewModel.DocumentRelationsFormViewModel;
  ...
  then begin
    ...
    if FDocumentChargesFrame is TDocumentChargeSheetsFrame then begin

      TDocumentChargeSheetsFrame(FDocumentChargesFrame).ViewModel :=
        ViewModel.DocumentChargeSheetsFormViewModel;
  ...
  if Assigned(FDocumentFilesViewFrame) then begin
    ...
    FDocumentFilesViewFrame.SetDocumentFileInfoList(
      FViewModel.DocumentFilesViewFormViewModel.DocumentFileInfoList
    );
...
procedure TDocumentCardFrame.OnDocumentUploadingToLoodsman(Sender: TObject);
begin

  if Assigned(FOnDocumentUploadingToLoodsmanEventHandler) then
    FOnDocumentUploadingToLoodsmanEventHandler(Self);

end;

procedure TDocumentCardFrame.OnCancellationDocumentUploadingToLoodsman(
  Sender: TObject);
begin

  if Assigned(FOnCancellationDocumentUploadingToLoodsmanEventHandler) then
    FOnCancellationDocumentUploadingToLoodsmanEventHandler(Self);
...
begin
  ...
  if not
     DocumentChargeSheetsFrame.
      ValidateAllowableForPerformingChargeSheetsSelected
  then Exit;
  ...
  then begin
    ...
    try
      ...
      SelectedChargeIds :=
        DocumentChargeSheetsFrame.FetchSelectedPerformableChargeSheetIds;
