...
type
  ...
  TDocumentCardFrameFactory = class
    ...
    protected
      ...
      function CreateDocumentChargeSheetsFrameInstance: TDocumentChargeSheetsFrame; virtual;
    ...
    protected
      ...
      function CreateDocumentChargeSheetsFrame(
        DocumentChargesFormViewModel: TDocumentChargeSheetsFormViewModel = nil;
        DocumentUsageEmployeeAccessRightsInfoDTO: TDocumentUsageEmployeeAccessRightsInfoDTO = nil
      ): TDocumentChargeSheetsFrame; virtual;
...
begin
  ...
  if Assigned(DocumentUsageEmployeeAccessRightsInfoDTO) then begin
    ...
    then begin
      ...
      Result.DocumentApproversInfoForm.AddingApproversOptionsVisible :=
        DocumentUsageEmployeeAccessRightsInfoDTO.CanBeChangedDocumentApproverList;

      Result.DocumentApproversInfoForm.RemovingApproversOptionsVisible :=
        DocumentUsageEmployeeAccessRightsInfoDTO.CanBeChangedDocumentApproverList;
...
begin
  ...
  if Assigned(ViewModel) then begin
    ...
    DocumentChargeSheetsFormViewModel := ViewModel.DocumentChargeSheetsFormViewModel;
    ...
    DocumentChargeSheetsFormViewModel := nil;
...
function TDocumentCardFrameFactory.CreateDocumentChargeSheetsFrameInstance: TDocumentChargeSheetsFrame;
begin
...
function TDocumentCardFrameFactory.CreateDocumentChargeSheetsFrame(
  DocumentChargesFormViewModel: TDocumentChargeSheetsFormViewModel;
  DocumentUsageEmployeeAccessRightsInfoDTO: TDocumentUsageEmployeeAccessRightsInfoDTO
