...
begin
  ...
  DocumentTypeEdit.Text := FViewModel.Kind;
  DocumentNameEdit.Text := FViewModel.Name;
  ...
  DocumentCreationDateTimePicker.DateTime := FViewModel.CreationDate;

  if not VarIsNull(FViewModel.DocumentDate) then
    DocumentDateTimePicker.DateTime := FViewModel.DocumentDate

  else FViewModel.DocumentDate := DocumentDateTimePicker.DateTime;
    
  DocumentContentMemo.Text := FViewModel.Content;
  DocumentNoteMemo.Text := FViewModel.Note;

  if not VarIsNull(FViewModel.IsSelfRegistered) then
    DocumentIsSelfRegisteredCheckBox.Checked := FViewModel.IsSelfRegistered

  else FViewModel.IsSelfRegistered := DocumentIsSelfRegisteredCheckBox.Checked;
