...
begin
  ...
  FDocumentApproversInfoForm.AddingApproversOptionsEnabled := False;
  FDocumentApproversInfoForm.RemovingApproversOptionsEnabled := False;
...
begin
  ...
  FDocumentApproversInfoForm.AddingApproversOptionsEnabled :=
    AddingApproversOptionsEnabled;

  FDocumentApproversInfoForm.RemovingApproversOptionsEnabled :=
...
begin
  ...
  try
    ...
    while not DocumentApprovingSetHolder.Eof do begin
      ...
      if DocumentApprovingSetHolder.ApprovingCycleIdFieldValue = Null
      then begin
    ...
    try
      ...
      DocumentApprovingSetHolder.GotoBookmarkAndFree(
        CurrentDocumentApprovingRecordPointer
      );
...
begin
  ...
  FDocumentApproversInfoForm.AddingApproversOptionsEnabled := not ViewOnly;
  FDocumentApproversInfoForm.RemovingApproversOptionsEnabled := not ViewOnly;
